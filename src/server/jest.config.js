...
module.exports = {
    ...
    // cacheDirectory: "/private/var/folders/3d/my733tj9449d7jbbq3h3395w0000gn/T/jest_dx",
    ...
    moduleNameMapper: {
        '\\.(jpg|jpeg|png|gif|eot|otf|webp|svg|ttf|woff|woff2|mp4|webm|wav|mp3|m4a|aac|oga|m4r)$':
    ...
    transform: {
        '^.+\\.(js|jsx|ts|tsx)$': '<rootDir>/config/nodeTransformer.js',
    },
